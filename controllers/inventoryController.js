...
const getInventoryController = async (req, res) => {
  try {
    const inventory = await inventoryModel
      ...
      .populate("donor")
      .populate("hospital")
      .sort({ createdAt: -1 }); //sort the inventories based on createdAt as we are using timestamps i.e latest records are placed at top....these are the filters that we add
...
module.exports = {
  ...
  getOrganisationsForHospitalsController,
