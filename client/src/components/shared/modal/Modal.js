            ...
            <div className='modal-content'>
                ...
                <div className='modal-body'>
                    <div className='d-flex mb-3'>
                        ...
                        {/* both the names should be same or else both the radio buttons will be selected differently */}
                        <div className='form-check ms-3'>
                    ...
                    <InputType labelText={'Donor Email'} labelFor={'donorEmail'} inputType={'email'} value={email} onChange={(e) => setEmail(e.target.value)}/>
